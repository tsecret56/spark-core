 ...
 */
  class BlockManager implements org.apache.spark.network.BlockDataManager, org.apache.spark.Logging {
  ...
  private  boolean externalBlockStoreInitialized () { throw new RuntimeException(); }
  ...
  public  org.apache.spark.storage.ExternalBlockStore externalBlockStore () { throw new RuntimeException(); }
   ...
   * @param mapOutputTracker (undocumented)
   * @param shuffleManager (undocumented)
   * @param blockTransferService (undocumented)
   * @param securityManager (undocumented)
   * @param numUsableCores (undocumented)
   */
  public   BlockManager (java.lang.String execId, org.apache.spark.rpc.RpcEnv rpcEnv, org.apache.spark.storage.BlockManagerMaster master, org.apache.spark.serializer.Serializer serializer, org.apache.spark.SparkConf conf, org.apache.spark.MapOutputTracker mapOutputTracker, org.apache.spark.shuffle.ShuffleManager shuffleManager, org.apache.spark.network.BlockTransferService blockTransferService, org.apache.spark.SecurityManager securityManager, int numUsableCores) { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.storage.BlockObjectWriter getDiskWriter (org.apache.spark.storage.BlockId blockId, java.io.File file, org.apache.spark.serializer.SerializerInstance serializerInstance, int bufferSize, org.apache.spark.executor.ShuffleWriteMetrics writeMetrics) { throw new RuntimeException(); }
  /**
   ...
   * @param effectiveStorageLevel (undocumented)
   * @return (undocumented)
   */
   ...
   * @return (undocumented)
   */
  public  scala.Option<org.apache.spark.storage.BlockStatus> dropFromMemory (org.apache.spark.storage.BlockId blockId, scala.Function0<scala.util.Either<java.lang.Object[], java.nio.ByteBuffer>> data) { throw new RuntimeException(); }
  /**
