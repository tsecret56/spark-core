 ...
 */
  class BlockManagerMasterEndpoint implements org.apache.spark.rpc.ThreadSafeRpcEndpoint, org.apache.spark.Logging {
  ...
  private  boolean updateBlockInfo (org.apache.spark.storage.BlockManagerId blockManagerId, org.apache.spark.storage.BlockId blockId, org.apache.spark.storage.StorageLevel storageLevel, long memSize, long diskSize, long externalBlockStoreSize) { throw new RuntimeException(); }
  ...
  /**
   * Returns the hostname and port of an executor, based on the {@link RpcEnv} address of its
   * {@link BlockManagerSlaveEndpoint}.
   * @param executorId (undocumented)
   * @return (undocumented)
   */
  private  scala.Option<scala.Tuple2<java.lang.String, java.lang.Object>> getRpcHostPortForExecutor (java.lang.String executorId) { throw new RuntimeException(); }
