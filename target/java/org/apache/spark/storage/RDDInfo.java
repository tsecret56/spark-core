...
public  class RDDInfo implements scala.math.Ordered<org.apache.spark.storage.RDDInfo> {
  ...
  // not preceding
  public   RDDInfo (int id, java.lang.String name, int numPartitions, org.apache.spark.storage.StorageLevel storageLevel, scala.collection.Seq<java.lang.Object> parentIds, scala.Option<org.apache.spark.rdd.RDDOperationScope> scope) { throw new RuntimeException(); }
