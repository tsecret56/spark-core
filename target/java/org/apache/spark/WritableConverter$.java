...
public  class WritableConverter$ implements scala.Serializable {
  ...
  public   WritableConverter$ () { throw new RuntimeException(); }
   <T extends java.lang.Object, W extends org.apache.hadoop.io.Writable> org.apache.spark.WritableConverter<T> simpleWritableConverter (scala.Function1<W, T> convert, scala.reflect.ClassTag<W> evidence$30) { throw new RuntimeException(); }
