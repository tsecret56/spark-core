...
public  class RRDD<T extends java.lang.Object> extends org.apache.spark.api.r.BaseRRDD<T, byte[]> {
  ...
  static private  org.apache.spark.api.r.BufferedStreamThread createRProcess (java.lang.String rLibDir, int port, java.lang.String script) { throw new RuntimeException(); }
  /**
   * ProcessBuilder used to launch worker R processes.
   * @param rLibDir (undocumented)
   * @param port (undocumented)
   * @return (undocumented)
   */
  static public  org.apache.spark.api.r.BufferedStreamThread createRWorker (java.lang.String rLibDir, int port) { throw new RuntimeException(); }
  /**
  ...
  public   RRDD (org.apache.spark.rdd.RDD<T> parent, byte[] func, java.lang.String deserializer, java.lang.String serializer, byte[] packageNames, java.lang.String rLibDir, java.lang.Object[] broadcastVars, scala.reflect.ClassTag<T> evidence$4) { throw new RuntimeException(); }
