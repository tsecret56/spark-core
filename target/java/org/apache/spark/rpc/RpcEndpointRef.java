 ...
 */
 abstract class RpcEndpointRef implements scala.Serializable, org.apache.spark.Logging {
   ...
   * @return (undocumented)
   */
  public abstract <T extends java.lang.Object> scala.concurrent.Future<T> ask (Object message, scala.concurrent.duration.FiniteDuration timeout, scala.reflect.ClassTag<T> evidence$1) ;
  /**
   * Send a message to the corresponding {@link RpcEndpoint.receiveAndReply)} and return a {@link Future} to
   ...
   */
  public <T extends java.lang.Object> T askWithRetry (Object message, scala.concurrent.duration.FiniteDuration timeout, scala.reflect.ClassTag<T> evidence$4) { throw new RuntimeException(); }
}
