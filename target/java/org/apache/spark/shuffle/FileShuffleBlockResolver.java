 ...
 */
  ...
  private  class ShuffleState {
    ...
    public  java.util.concurrent.ConcurrentLinkedQueue<org.apache.spark.shuffle.FileShuffleBlockResolver.ShuffleFileGroup> unusedFileGroups () { throw new RuntimeException(); }
    public  java.util.concurrent.ConcurrentLinkedQueue<org.apache.spark.shuffle.FileShuffleBlockResolver.ShuffleFileGroup> allFileGroups () { throw new RuntimeException(); }
    /**
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.shuffle.ShuffleWriterGroup forMapTask (int shuffleId, int mapId, int numBuckets, org.apache.spark.serializer.Serializer serializer, org.apache.spark.executor.ShuffleWriteMetrics writeMetrics) { throw new RuntimeException(); }
