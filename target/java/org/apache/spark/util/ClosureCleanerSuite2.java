...
public  class ClosureCleanerSuite2 extends org.apache.spark.SparkFunSuite implements org.scalatest.BeforeAndAfterAll, org.scalatest.PrivateMethodTester {
  ...
  private  org.scalatest.PrivateMethodTester.PrivateMethod<scala.collection.immutable.List<java.lang.Class<?>>> _getOuterClasses () { throw new RuntimeException(); }
  private  org.scalatest.PrivateMethodTester.PrivateMethod<scala.collection.immutable.List<java.lang.Object>> _getOuterObjects () { throw new RuntimeException(); }
  ...
  private  scala.collection.immutable.List<java.lang.Class<?>> getOuterClasses (java.lang.Object closure) { throw new RuntimeException(); }
  private  scala.collection.immutable.List<java.lang.Object> getOuterObjects (java.lang.Object closure) { throw new RuntimeException(); }
}
