 ...
 */
  ...
  private  int metaInitialRecords () { throw new RuntimeException(); }
  private  int kvChunkSize () { throw new RuntimeException(); }
  private  boolean useSerializedPairBuffer () { throw new RuntimeException(); }
  private  org.apache.spark.util.collection.PartitionedAppendOnlyMap<K, C> map () { throw new RuntimeException(); }
  private  org.apache.spark.util.collection.SizeTracker buffer () { throw new RuntimeException(); }
   ...
   */
  private  void spillToMergeableFile (org.apache.spark.util.collection.WritablePartitionedPairCollection<K, C> collection) { throw new RuntimeException(); }
  /**
   ...
   * @param collection whichever collection we're using (map or buffer)
   */
  private  void spillToPartitionFiles (org.apache.spark.util.collection.WritablePartitionedPairCollection<K, C> collection) { throw new RuntimeException(); }
  private  void spillToPartitionFiles (org.apache.spark.util.collection.WritablePartitionedIterator iterator) { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  private  scala.collection.Iterator<scala.Product2<K, C>> readPartitionFile (org.apache.spark.storage.BlockObjectWriter writer) { throw new RuntimeException(); }
