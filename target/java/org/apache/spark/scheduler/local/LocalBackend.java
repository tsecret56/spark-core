 ...
 */
  class LocalBackend implements org.apache.spark.scheduler.SchedulerBackend, org.apache.spark.executor.ExecutorBackend, org.apache.spark.Logging {
  public  int totalCores () { throw new RuntimeException(); }
  // not preceding
  public   LocalBackend (org.apache.spark.SparkConf conf, org.apache.spark.scheduler.TaskSchedulerImpl scheduler, int totalCores) { throw new RuntimeException(); }
  private  java.lang.String appId () { throw new RuntimeException(); }
  public  org.apache.spark.rpc.RpcEndpointRef localEndpoint () { throw new RuntimeException(); }
