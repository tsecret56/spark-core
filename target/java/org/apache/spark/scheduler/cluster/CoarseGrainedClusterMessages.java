...
// no position
  class CoarseGrainedClusterMessages {
  // no position
  ...
  static public  class RegisterExecutor implements org.apache.spark.scheduler.cluster.CoarseGrainedClusterMessage, scala.Product, scala.Serializable {
    ...
    // not preceding
    public   RegisterExecutor (java.lang.String executorId, org.apache.spark.rpc.RpcEndpointRef executorRef, java.lang.String hostPort, int cores, scala.collection.immutable.Map<java.lang.String, java.lang.String> logUrls) { throw new RuntimeException(); }
  }
  // no position
