...
public  class SparkListenerApplicationStart implements org.apache.spark.scheduler.SparkListenerEvent, scala.Product, scala.Serializable {
  ...
  // not preceding
  public   SparkListenerApplicationStart (java.lang.String appName, scala.Option<java.lang.String> appId, long time, java.lang.String sparkUser, scala.Option<java.lang.String> appAttemptId) { throw new RuntimeException(); }
}
