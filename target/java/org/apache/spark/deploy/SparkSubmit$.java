...
public  class SparkSubmit$ {
  ...
  public  java.io.PrintStream printStream () { throw new RuntimeException(); }
    void printWarning (java.lang.String str) { throw new RuntimeException(); }
    void printErrorAndExit (java.lang.String str) { throw new RuntimeException(); }
   ...
   * @return (undocumented)
   */
  private  boolean isSqlShell (java.lang.String mainClass) { throw new RuntimeException(); }
  /**
