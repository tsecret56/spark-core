...
// no position
   ...
   * @return (undocumented)
   */
  static private  java.io.File pathFromCoordinate (org.apache.spark.deploy.SparkSubmitUtils.MavenCoordinate artifact, java.io.File prefix, java.lang.String ext, boolean useIvyLayout) { throw new RuntimeException(); }
  /** Returns the artifact naming based on standard ivy or maven format. */
  static private  java.lang.String artifactName (org.apache.spark.deploy.SparkSubmitUtils.MavenCoordinate artifact, boolean useIvyLayout, java.lang.String ext) { throw new RuntimeException(); }
  ...
  static private  java.io.File writeFile (java.io.File dir, java.lang.String fileName, java.lang.String contents) { throw new RuntimeException(); }
  ...
  static private  java.io.File packJar (java.io.File dir, org.apache.spark.deploy.SparkSubmitUtils.MavenCoordinate artifact, scala.collection.Seq<scala.Tuple2<java.lang.String, java.io.File>> files, boolean useIvyLayout) { throw new RuntimeException(); }
  /**
   ...
   */
  static private  java.io.File createLocalRepository (org.apache.spark.deploy.SparkSubmitUtils.MavenCoordinate artifact, scala.Option<scala.collection.Seq<org.apache.spark.deploy.SparkSubmitUtils.MavenCoordinate>> dependencies, scala.Option<java.io.File> tempDir, boolean useIvyLayout, boolean withPython) { throw new RuntimeException(); }
  /**
   ...
   */
  static   java.io.File createLocalRepositoryForTests (org.apache.spark.deploy.SparkSubmitUtils.MavenCoordinate artifact, scala.Option<java.lang.String> dependencies, scala.Option<java.io.File> rootDir, boolean useIvyLayout, boolean withPython) { throw new RuntimeException(); }
  /**
   ...
   */
  static   void withRepository (org.apache.spark.deploy.SparkSubmitUtils.MavenCoordinate artifact, scala.Option<java.lang.String> dependencies, scala.Option<java.io.File> rootDir, boolean useIvyLayout, boolean withPython, org.apache.ivy.core.settings.IvySettings ivySettings, scala.Function1<java.lang.String, scala.runtime.BoxedUnit> f) { throw new RuntimeException(); }
