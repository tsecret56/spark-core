 ...
 */
  class AppClient implements org.apache.spark.Logging {
  ...
  private  java.lang.String[] masterAkkaUrls () { throw new RuntimeException(); }
  private  scala.concurrent.duration.FiniteDuration REGISTRATION_TIMEOUT () { throw new RuntimeException(); }
